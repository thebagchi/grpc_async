...
::grpc::Status SampleSvc::Stub::RPC_1(::grpc::ClientContext* context, const ::rpc::RPC1Request& request, ::rpc::RPC1Response* response) {
...
void SampleSvc::Stub::async::RPC_1(::grpc::ClientContext* context, const ::rpc::RPC1Request* request, ::rpc::RPC1Response* response, std::function<void(::grpc::Status)> f) {
...
void SampleSvc::Stub::async::RPC_1(::grpc::ClientContext* context, const ::rpc::RPC1Request* request, ::rpc::RPC1Response* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::rpc::RPC1Response>* SampleSvc::Stub::PrepareAsyncRPC_1Raw(::grpc::ClientContext* context, const ::rpc::RPC1Request& request, ::grpc::CompletionQueue* cq) {
...
::grpc::ClientAsyncResponseReader< ::rpc::RPC1Response>* SampleSvc::Stub::AsyncRPC_1Raw(::grpc::ClientContext* context, const ::rpc::RPC1Request& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
::grpc::Status SampleSvc::Stub::RPC_2(::grpc::ClientContext* context, const ::rpc::RPC2Request& request, ::rpc::RPC2Response* response) {
...
void SampleSvc::Stub::async::RPC_2(::grpc::ClientContext* context, const ::rpc::RPC2Request* request, ::rpc::RPC2Response* response, std::function<void(::grpc::Status)> f) {
...
void SampleSvc::Stub::async::RPC_2(::grpc::ClientContext* context, const ::rpc::RPC2Request* request, ::rpc::RPC2Response* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::rpc::RPC2Response>* SampleSvc::Stub::PrepareAsyncRPC_2Raw(::grpc::ClientContext* context, const ::rpc::RPC2Request& request, ::grpc::CompletionQueue* cq) {
...
::grpc::ClientAsyncResponseReader< ::rpc::RPC2Response>* SampleSvc::Stub::AsyncRPC_2Raw(::grpc::ClientContext* context, const ::rpc::RPC2Request& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
SampleSvc::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< SampleSvc::Service, ::rpc::RPC1Request, ::rpc::RPC1Response, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](SampleSvc::Service* service,
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< SampleSvc::Service, ::rpc::RPC2Request, ::rpc::RPC2Response, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](SampleSvc::Service* service,
             ::grpc::ServerContext* ctx,
...
::grpc::Status SampleSvc::Service::RPC_1(::grpc::ServerContext* context, const ::rpc::RPC1Request* request, ::rpc::RPC1Response* response) {
  (void) context;
  (void) request;
  (void) response;
...
::grpc::Status SampleSvc::Service::RPC_2(::grpc::ServerContext* context, const ::rpc::RPC2Request* request, ::rpc::RPC2Response* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
